...
public class TestCreateStatement {
	public static void main(String[] args) {
		...
		try {
			...
			String url = "jdbc:mysql://192.168.10.117:3306/dac67";
			...
			String source = "Amravati";
			String destination = "Banglore";

			String query = "insert into trains values(" + trainid + ",'" + trainname + "','" + source + "','"
					+ destination + "')";
